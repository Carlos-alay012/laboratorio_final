...
namespace Laboratorio_final.clases
{
    public class GestorEmpleados
    {
        ...
        {
            connectionString = "Data Source =c:\\TMP\\Empleados2.db";
        }
        ...
        public void CrearTabla()
        {
            ...
            {
                connection.Open();
                string sql = "CREATE TABLE IF NOT EXISTS Empleados (Id INTEGER PRIMARY KEY AUTOINCREMENT, Nombre VARCHAR(100), Apellido VARCHAR(100), Edad INTEGER, Cargo VARCHAR(100), Sueldo DECIMAL(100))";
